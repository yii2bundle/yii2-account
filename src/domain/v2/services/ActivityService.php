...
use yii2bundle\account\domain\v2\interfaces\services\ActivityInterface;
 ...
 * @property-read \yii2bundle\account\domain\v2\interfaces\repositories\ActivityInterface $repository
 */
