...
use yii2bundle\account\domain\v2\interfaces\services\OauthInterface;
...
class OauthService extends BaseService implements OauthInterface {
	...
	/** @var \yii2bundle\account\domain\v2\interfaces\repositories\LoginInterface */
	...
	public function init() {
		...
		try {
			/** @var \yii2bundle\account\domain\v2\interfaces\repositories\LoginInterface $arLoginRepository */
